...
namespace DAL_BLL
{
    public class BLL_UserManagement
    {
        ...
        public DataTable GetDBName(string strServer, string strUsername, string strPassword)
        {
            ...
            //SqlDataAdapter da = new SqlDataAdapter("SELECT NAME FROM sys.Databases", "Data Source=" + strServer + ";Initial Catalog=" + strDBName + "; Integrated Security = True ";
        ...
        {
            //Data Source = DESKTOP - MV9LD99; Initial Catalog = dbQuanLyQuanCafe; Integrated Security = True
            //DAL_BLL.Properties.Settings.Default.dbQLQCFConn = "Data Source=" + strServer + ";Initial Catalog=" + strDBName + "; Integrated Security = True ";
        ...
        public void SaveLinqConfig(string strServer, string strUsername, string strPassword, string strDBName)
        {
            ...
            //string connectionString = "Data Source=" + strServer + ";Initial Catalog=" + strDBName + "; Integrated Security = True ";
